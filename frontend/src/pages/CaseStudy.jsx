    ...
    <div className="grain relative min-h-screen bg-ink">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:py-20">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a
            href={`https://github.com/AkibHasan2/Portfolio/blob/main/docs/projects/${slug}.md`}
            target="_blank"
            rel="noreferrer"
            className="rounded-md border border-rule px-4 py-2 text-sm font-semibold text-paper"
          >
            GitHub brief
          </a>
